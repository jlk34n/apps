...
function queryEditor2() {
    ...
    jQuery('#xboxItem').on('click', function(e) {
        ...
        jQuery('#big-search').focus(); // not sure yet why this doesn't work 100% of the time ... may have to do w/ event props sequence
    ...
    jQuery('#SearchTerm1, #Searchbox1').keyup(function() {
        // experimental
        // if charlimit is 0 (see line 50 above), do not expose big-search unless clicked
